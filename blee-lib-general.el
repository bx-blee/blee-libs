...
;;;#+BEGINNOT: bx:dblock:lisp:loading-message :disabledP "false" :message "blee-lib-general"
(lambda () "
*  [[elisp:(org-cycle)][| ]]  "Loading..."                :: Loading Announcement Message blee-lib-general [[elisp:(org-cycle)][| ]]
")

(message "Loading: blee-lib-general")
;;;#+END:
...
;;;
;;; call-stack and compile-time-function-name are taken from:
